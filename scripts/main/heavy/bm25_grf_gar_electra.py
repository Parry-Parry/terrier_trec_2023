...
def main(out_dir : str, irds : str = None, path : str = None, name : str = None, budget : int = 5000, batch_size : int = 16):
    ...
    gar = trec23.load_gar(electra, CONFIG['GAR_GRAPH_PATH'], num_results=budget, batch_size=batch_size)
